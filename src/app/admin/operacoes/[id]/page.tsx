            ...
            <div className="space-y-2">
              <div className="flex items-start justify-between gap-3 flex-wrap">
                <div className="text-base font-bold">
                  ...
                  <span className="ml-2 inline-flex items-center px-2 py-0.5 rounded-full text-[10px] uppercase tracking-wider font-mono font-semibold bg-bg-card text-fg-muted border border-border">
                ...
                {op.compradores.map((c) => (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-0.5 text-xs text-fg-muted font-mono">
                      <span>{c.tipoPessoa === "fisica" ? "CPF" : "CNPJ"} {c.documento}</span>
                      <a
                        href={`mailto:${c.email}`}
                        className="hover:text-accent"
                      >
