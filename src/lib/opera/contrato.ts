...
const APELIDOS: Record<string, string> = {
  ...
  aguardando_confirmacao_do_cedente: "aguardando_confirmacao",
  aguardando_confirmacao_cedente: "aguardando_confirmacao",
  aguardando_cedente: "aguardando_confirmacao",
  confirmacao_do_cedente: "aguardando_confirmacao",
